                ...
                <div class="space-x-1">
                    <ul class="nav-main nav-main-horizontal nav-main-hover nav">
                        <li class="nav-main-item">
                            <a class="btn rounded-pill btn-alt-secondary px-3" data-toggle="layout"
                    ...
                    <div class="row g-0 justify-content-center text-center mb-5">
                        ...
                        <div class="col-xl-4 invisible" data-toggle="appear" data-class="animated flipInX">
                            <div class="w-100 py-4">
                                ...
                                <p class="fw-medium text-dark mb-0">
                                    Sau khi hoàn thành bài kiểm tra trắc nghiệm hệ thống sẽ thông báo số điểm đạt được
                        ...
                        <div class="row">
                            ...
                            <div class="order-md-0 col-md-6 d-flex align-items-center">
                                <div>
                                    ...
                                    <p class="mb-2">Hệ thống dễ dàng tạo đề thi với nhiều tuỳ chọn, giúp giảng viên tạo
                                    ...
                                    <ul class="text-dark mb-4 m-0 list-unstyled">
                                        ...
                                        <li class="list-landing">Trả lời bằng cách upload file (Hình ảnh, word, video)
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="order-md-1 col-md-6 d-flex align-items-center">
                                <div>
                                    ...
                                    <ul class="text-dark mb-4 m-0 list-unstyled">
                                        <li class="list-landing">Qui định thời gian cho bài làm</li>
                                        <li class="list-landing">Qui định thời gian có thể bắt đầu làm bài</li>
                                        <li class="list-landing">Qui định thời gian kết thúc hiệu lực làm bài</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="order-md-0 col-md-6 d-flex align-items-center">
                                <div>
                                    ...
                                    <ul class="text-dark mb-4 m-0 list-unstyled">
                                        <li class="list-landing">Học sinh dễ dàng truy cập và làm bài thi mà không cần
                                            cài đặt thêm ứng dụng</li>
                                        <li class="list-landing">Giao diện làm bài kiểm tra trực quan và dễ tương tác
                                        </li>
                                        <li class="list-landing">Giao diện tuỳ biến theo kích thước màn hình </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
