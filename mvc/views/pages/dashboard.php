                    ...
                    <div class="bg-body-extra-light shadow-lg">
                        <div class="js-slider slick-dotted-inner" data-dots="true" data-arrows="false"
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-muted">
                                    Hệ thống thi trực tuyến kiểm tra online, bạn vui lòng điển đầy đủ thông tin để
                                    sử dụng đầy đủ các tính năng của chúng tôi
                                </p>
                                <button type="button" class="btn btn-alt-primary mb-4"
                                ...
                                <form class="mb-4">
                                    <div class="mb-4">
                                        <input type="text" class="form-control form-control-alt" id="email"
                                            name="onboard-first-name" placeholder="Nhập địa chỉ email của bạn ...">
                                    </div>
                                </form>
