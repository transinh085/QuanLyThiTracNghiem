        ...
        <div class="d-md-flex justify-content-md-between align-items-md-center">
                <div class="p-1 p-md-3">
                    <div class="flex-grow-1 fs-sm pe-2 mb-2">
                        <h4 class="fw-bold mb-2 truncate truncate--1">${
                          announce.noidung
                        }</h4>
                    </div>
                    <p class="fs-sm text-muted mb-2">
                        <i class="fa fa-layer-group me-1"></i> Gửi cho học phần <strong data-bs-toggle="tooltip" data-bs-animation="true" data-bs-placement="top" style="cursor:pointer" data-bs-original-title="${
                          announce.nhom
        ...
        announce.hocky
                ...
                <div class="p-1 p-md-3">
                    <a class="btn btn-sm btn-alt-success rounded-pill px-3 me-1 my-1" href="javascript:void(0)">
                        <i class="fa fa-clock opacity-50 me-1"></i> ${formatDate(
                          announce.thoigiantao
                        )}
                    </a>
                    <a data-role="thongbao" và data-action="update" class="btn btn-sm btn-alt-primary rounded-pill px-3 me-1 my-1" href="./teacher_announcement/update/${
                      announce.matb
                    }">
                        <i class="fa fa-wrench opacity-50 me-1"></i> Chỉnh sửa
                    </a>
                    <a data-role="thongbao" và data-action="delete" class="btn btn-sm btn-alt-danger rounded-pill px-3 my-1 btn-delete" href="javascript:void(0)" data-id="${
                      announce.matb
                    }">
