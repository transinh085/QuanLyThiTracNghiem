 ...
 *   $links = $loggingService->locations_buckets_links;
 *  </code>
 */
class LocationsBucketsLinks extends \Google\Service\Resource
{
  ...
  /**
   * Lists links. (links.listLocationsBucketsLinks)
   *
   ...
   */
  public function listLocationsBucketsLinks($parent, $optParams = [])
  {
...
class_alias(LocationsBucketsLinks::class, 'Google_Service_Logging_Resource_LocationsBucketsLinks');
