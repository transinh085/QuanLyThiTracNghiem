 ...
 *  </code>
 */
class ProjectsLocationsBucketsLinks extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsLocationsBucketsLinks::class, 'Google_Service_Logging_Resource_ProjectsLocationsBucketsLinks');
